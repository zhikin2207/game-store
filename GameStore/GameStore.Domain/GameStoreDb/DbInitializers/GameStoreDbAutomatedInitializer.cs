...
namespace GameStore.Domain.GameStoreDb.DbInitializers
{
	public class GameStoreDbAutomatedInitializer : CreateDatabaseIfNotExists<GameStoreContext>
	{
		...
		private readonly string[] _enWords =
		{
		...
		#region Ukrainian words

		private readonly string[] _ukWords =
		{
			"Аби", "Агенція", "Але", "Але", "Ж", "Альтанка", "Аматор", "Амбасада", "Аркуш", "Багнет", "Багно", "Байка", "Баламут",
			"Балія", "Барва", "Батог", "Башта", "Безлад", "Белькотання", "Білизна", "Блазень", "Блакитний", "Блискавка",
			"Бляшанка", "Бо", "Боївка", "Борг", "Брак", "Брама", "Братерство", "Бриля", "Бруд", "Брутальний", "Будинок",
			"Бурштин", "Вага", "Вада", "Вапно", "Варта", "Вартість", "Великий", "Вельмишановний", "Верства", "Веслування",
			"Вечорниця", "Вибачати", "Виборчий", "Вибух", "Видатний", "Виднокруг", "Видовисько", "Виконати", "Викреслити",
			"Викрити", "Вимагати", "Вимір", "Винищувати", "Винний", "Виняток", "Випадок", "Випробування", "Вир", "Вирушати",
			"Вистава", "Витримати", "Витягнути", "Виховання", "Відень", "Відомо", "Відшкодувати", "Вік", "Влада", "Влох",
			"Вовкулак", "Водоспад", "Войовничий", "Вплив", "Вправний", "Впровадити", "Вразливість", "Врешті", "Втручатися",
			"В’язень", "Гай", "Гайворон", "Гак", "Галас", "Галузь", "Ганок", "Ганьба", "Гармата", "Гарт", "Гасло", "Гатунок",
			"Гвалт", "Генерація", "Гинути", "Гідність", "Глод", "Гнобити", "Гной", "Гоїти", "Голити", "Голосно", "Голота",
			"Господарство", "Готівка", "Гребля", "Гречкосій", "Громада", "Гроно", "Грудень", "Губити", "Гудзик", "Гума", "Гуркіт",
			"Даремно", "Дарма", "Дзвін", "Дзьоб", "Дівчина", "Діжка", "Добробут", "Довести", "Довколо", "Догана", "Догори",
			"Додавати", "Додому", "Дорадник", "Досить", "Другорядний", "єдність", "Жадати", "Жалоба", "Жарт", "Жваво", "Жебрак",
			"Живиця", "Живлення", "Живцем", "Жито", "Життя", "Жнива", "Жоден", "Жужіль", "Жуйка", "З", "З-за", "Забити",
			"Забобон", "Забов’язати", "Забороняти", "Забудова", "Забуток", "Завада", "Завжди", "Завзятий", "Завчасно", "Завітати",
			"Загарбати", "Загартований", "Загинути", "Загоїти", "Загубити", "Зажадати", "Заздрість", "Зазнати", "Зазначити",
			"Займенник", "Заклад", "Заклопотаний", "Закоханий", "Закрутка", "Закутий", "Залежати", "Залицятися", "Залога",
			"Залюдняти", "Замах", "Замкнути", "Замовити", "Заможний", "Замордувати", "Замулити", "Замість", "Занадто",
			"Занедбаний", "Занотувати", "Зануряти", "Заохотити", "Запал", "Запалення", "Запалити", "Запальничка", "Запаска",
			"Запевнити", "Запеклий", "Запитання", "Заплав", "Запобігливий", "Запропонувати", "Запхати", "Зап’ятий", "Зарадити",
			"Зараз", "Заробити", "Засада", "Заспівати", "Застосувати", "Заступник", "Зателефонувати", "Затока", "Затримати",
			"Затулити", "Затятість", "Зауважити", "Захват", "Захід", "Зацікавити", "Зашкодити", "Збанкрутувати", "Збочити",
			"Зброя", "Збудити", "Збудувати", "Збіг", "Збіжжя", "Зважати", "Зверхність", "Звиклий", "Звироднілий", "Звичай",
			"Зволікання", "Згаслий", "Згвалтування", "Згода", "Згори", "Зграя", "Здатність", "Здається", "Здобич", "Здолати",
			"Здряпати", "Здрібнілий", "Зиск", "Зле", "Злодій", "Злочинець", "Змова", "Зморшка", "Змусити", "Зміна", "Змінний",
			"Знайда", "Знаний", "Зневага", "Зненавидити", "Зненацька", "Зникати", "Знову", "Знущатися", "Зобов’язати",
			"Зовнішний", "Зодовільняти", "Зошит", "Зрада", "Зранку", "Зрештою", "Зробити", "Зрозумілий", "Зруйнувати", "Зсувати",
			"Зубожіння", "Зухвало", "індик", "інший", "Кава", "Кав’ярня", "Кайдани", "Канапа", "Кашкет", "Квітень", "Келих",
			"Керувати", "Кишеня", "Кнур", "Колисанка", "Коло", "Коло", "Комора", "Кошик", "Коштовність", "Краватка", "Кравець",
			"Крадіжка", "Крапля", "Кресало", "Крок", "Кроква", "Крук", "Кудлатий", "Кулька", "Куля", "Купа", "Курча", "Кут",
			"Кухоль", "Лагідний", "Лазня", "Лан", "Ласка", "Лаяти", "Ледве", "Лемент", "Липень", "Лихо", "Ліжко", "Лобода",
			"Лужний", "Луска", "Лупати", "Маєток", "Макуха", "Малярство", "Мапа", "Мешканець", "Місто", "Мовити", "Можливо",
			"Мружитися", "Мул", "Мурований", "Мусить", "Муслін", "Набой", "Навколо", "Надзвичайно", "Надмір", "Найближчий",
			"Наймит", "Наклад", "Належне", "Напій", "Наречений", "Натхнення", "Недоречний", "Неділя", "Незлічений", "Нелюдський",
			"Несвідомість", "Нескінчений", "Несподівано", "Нотатка", "Ноші", "Обуритися", "Огидний", "Ознака", "Око", "Оксамит",
			"Опір", "Опріч", "Ослін", "Остаточно", "Пагорб", "Пазур", "Палац", "Паливо", "Палити", "Пан", "Панич", "Панна",
			"Панувати", "Панщина", "Папір", "Парасолька", "Паркан", "Паша", "Пекло", "Пензель", "Перешкодити", "Перли", "Печеня",
			"Питання", "Пиха", "Підмет", "Підступний", "Підсумовувати", "Піхва", "Пляма", "Поблизу", "Повинен", "Повідомити",
			"Повідомляти", "Повітря", "Повстання", "Погляд", "Подарунок", "По-друге", "Подряпати", "Поза", "Позичати",
			"Покладати", "Покотем", "Пологовий", "Полювати", "Попит", "Порада", "Поразка", "Поратися", "Порцеляна", "Посада",
			"Посуха", "Потилиця", "Потуга", "Правдоподібно", "Прагнення", "Прапор", "Прасувати", "Призьба", "Прикрость", "Примус",
			"Принаймі", "Пухлина", "Разом", "Раптом", "Регот", "Решта", "Риса", "Рідкий", "Рік", "Робити", "Розвага", "Розмова",
			"Розпач", "Розпуста", "Російський", "Рудий", "Рух", "Смажити", "Скарб", "Скарга", "Скористатися", "Скроня", "Скубати",
			"Смак", "Смарагд", "Смерека", "Смуток", "Сніданок", "Спис", "Сповідь", "Сподіватися", "Спритний", "Сприяти",
			"Спростувати", "Спротив", "Спіж", "Стайня", "Стискати", "Стілець", "Страва", "Страйк", "Сумління", "Сурма",
			"Сходинка", "Так", "Тесля", "Торба", "Тортури", "Тримати", "Труна", "Тутешній", "Увага", "Ув’язнення", "Угода",
			"Угорі", "Умова", "Уникати", "Врода", "Фарба", "Фіранка", "Фортеця", "Фурман", "Хвилина", "Хвіртка", "Хвороба",
			"Хилити", "Хіба", "Хорт", "Цвинтар", "Цегла", "Цибуля", "Цілковито", "Цукерка", "Чапля", "Чарівник", "Час", "Частка",
			"Чекати", "Червень", "Червоний", "Черевик", "Чи", "Чинний", "Чому", "Чуприна", "Шаль", "Шибениця", "Шибка", "Шинок",
			"Шкапа", "Шкіра", "Шкода", "Шлюб", "Шляхетний", "Шмагати", "Щохвилини", "Шпиталь", "Штучний", "Шукати", "Щупак",
			"Щур", "Як", "Який", "Якийсь", "Якість", "Якось"
		};
		...
		private static void AddConstraints(GameStoreContext context)
		{
			...
			context.Database.ExecuteSqlCommand("ALTER TABLE \"Users\" ADD CONSTRAINT User_Publisher FOREIGN KEY (PublisherId) REFERENCES dbo.Publishers(PublisherId) ON UPDATE NO ACTION ON DELETE SET NULL");
		...
		private void InitManuallyGenres(GameStoreContext context)
		{
			context.Genres.Add(new Genre
			{
				Name = "Strategy",
				ParentGenreId = null,
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Стратегія", Language = Language.Uk }
				}
			});
			...
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Рольова Гра", Language = Language.Uk }
				}
			});
			...
			{ 
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Спорт", Language = Language.Uk }
				}
			});
			...
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Перегони", Language = Language.Uk }
				}
			});
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Екшн", Language = Language.Uk }
				}
			});
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Пригоди", Language = Language.Uk }
				}
			});
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Логіка та мастерство", Language = Language.Uk }
				}
			});
			...
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "РТС", Language = Language.Uk }
				}
			});
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "ТБС", Language = Language.Uk }
				}
			});
			...
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Ралі", Language = Language.Uk }
				}
			});
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Аркада", Language = Language.Uk }
				}
			});
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Формула", Language = Language.Uk }
				}
			});
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Бездоріжжя", Language = Language.Uk }
				}
			});
			...
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "ФПС", Language = Language.Uk }
				}
			});
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "ТПС", Language = Language.Uk }
				}
			});
			context.Genres.Add(new Genre
			{
				...
				GenreLocalizations = new[]
				{
					new GenreLocalization { Name = "Різне", Language = Language.Uk }
				}
			});
			context.SaveChanges();
		}
		...
		private Genre GetRandomGenre(Random random)
		{
			return new Genre
			{
				Name = GetRandomTitle(1, 2, random, _enWords)
			};
		}
		...
		private PlatformType GetRandomPlatform(Random random)
		{
			...
			{
				Type = GetRandomTitle(1, 2, random, _enWords),
				PlatformLocalizations = new[]
				{
					new PlatformLocalization
					{
						Language = Language.Uk,
						Type = GetRandomTitle(1, 2, random, _ukWords)
					}
				}
			};
		}
		...
		private Publisher GetRandomPublisher(Random random)
		{
			var publisher = new Publisher
			{
				CompanyName = GetRandomTitle(1, 4, random, _enWords),
				Description = GetRandomText(5, 15, random, _enWords),
				PublisherLocalizations = new List<PublisherLocalization>
				{
					new PublisherLocalization
					{
						Language = Language.Uk,
						CompanyName = GetRandomTitle(1, 4, random, _ukWords),
						Description = GetRandomText(5, 15, random, _ukWords)
					}
				}
			};
		...
		private Comment GetRandomComment(string gameKey, Random random)
		{
			return new Comment
			{
				Name = GetRandomTitle(1, 3, random, _enWords),
				GameKey = gameKey,
				Body = GetRandomText(4, 15, random, _enWords),
				Date = GetRandomDate(2000, random)
			};
		}
		...
		private Game GetRandomGame(string gameKey, Random random)
		{
			...
			{
				Key = gameKey,
				Name = GetRandomTitle(3, 7, random, _enWords),
				Description = GetRandomText(15, 30, random, _enWords),
				...
				GameLocalizations = new Collection<GameLocalization>
				{
					new GameLocalization
					{
						Language = Language.Uk,
						Name = GetRandomTitle(3, 7, random, _ukWords),
						Description = GetRandomText(15, 30, random, _ukWords)
					}
				}
			};
		}
		...
		private string GetRandomTitle(int fromCountWords, int toCountWords, Random random, string[] words)
		{
			int count = random.Next(fromCountWords, toCountWords);
			var title = new StringBuilder();

			title.Append(words[random.Next(0, words.Length)]);
		...
		private string GetRandomText(int fromCountWords, int toCountWords, Random random, string[] words)
		{
			int count = random.Next(fromCountWords, toCountWords);
			var gameDescription = new StringBuilder();

			gameDescription.Append(words[random.Next(0, words.Length)]);
			for (int i = 0; i < count - 1; i++)
			{
				...
				gameDescription.Append(" ");
				gameDescription.Append(words[random.Next(0, words.Length)].ToLower());
			}
